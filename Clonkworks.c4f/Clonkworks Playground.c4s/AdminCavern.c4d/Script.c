...
func Update(){
	...
	var items = [CVCB,MGNT,GUNP,HTRY,RPSG,GOLD, ABRL, BARL, LBRL, OBRL, WBRL, CNKT, LNKT, FNKT, ASHS, COAL, CNCR, CRYS, ERTH,LIQG, LOAM, METL, CPIG, TTIG, ROCK, WOOD, ARWP, XARP, FARP, FBMP, FLNT, GUNP, SFLN, STFN, TFLN, EFLN, TRP1, BFLN, SBFN, SFN_, BALN, BLMP, CANN, CATA, XBOW, LORY, SLBT, STMG, SUB1, WAGN, HONY,CBAT, SPHR, ALC_, LQTK, BRDG, MTBK, ADM3, SBLW, PHNG, CPBT, CW5P, CK5P, SMJP, MDRL];
